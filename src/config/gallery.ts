...
export const galleryImages: GalleryImage[] = [
  ...
  { id: 'g6', src: '/images/gallery/automated-pergola-1.jpg', thumbnail: '/images/gallery/automated-pergola-1.jpg', alt: 'Automated louvered pergola over outdoor seating area', category: 'Automated Pergolas', title: 'Louvered Pergola Lounge', description: 'Motorized louvered pergola with adjustable shade' },
  ...
  { id: 'g12', src: '/images/gallery/automated-pergola-2.jpg', thumbnail: '/images/gallery/automated-pergola-2.jpg', alt: 'Automated pergola with integrated LED lighting at dusk', category: 'Automated Pergolas', title: 'Evening Under the Louvers', description: 'Automated pergola with integrated lighting and rain protection' },
];
